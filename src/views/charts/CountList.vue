<template>
    <div>
        ...
        <Table :columns="columns8" :data="data7" size="small" ref="table" style="margin-top: 30px" border></Table>
        <br>
        ...
        <Page :total="100" show-elevator style="display: flex;justify-content: center"></Page>
    </div>
